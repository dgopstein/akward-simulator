...
//            drawing.DrawPath (history.Select (s => s.P1.Coords), Color.Thistle, 2);
            ...
            drawing.DrawPaths (aiInput.ai1.BestPaths ().Select(p => p.Select(e => e.Item2.P1.Coords)));
            drawing.DrawPaths (aiInput.ai2.BestPaths ().Select(p => p.Select(e => e.Item2.P2.Coords)));
