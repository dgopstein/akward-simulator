...
namespace FarseerPhysics.Samples.DrawingSystem
{
    ...
    public class AssetCreator
    {
        ...
        public static Microsoft.Xna.Framework.Vector2 CalculateOrigin(Body b)
        {
        ...
        public Texture2D CircleTexture(float radius, Texture2D material, Color color, float materialScale)
        {
            return EllipseTexture(radius, radius, material, color, materialScale);
        }

        public Texture2D EllipseTexture(float radiusX, float radiusY, MaterialType type, Color color, float materialScale) {
            return EllipseTexture (radiusX, radiusY, _materials [type], color, materialScale);
        }

        public Texture2D EllipseTexture(float radiusX, float radiusY, Texture2D material, Color color, float materialScale)
        {
            ...
            return RenderTexture((int)(radiusX * 2f), (int)(radiusY * 2f), material, verticesFill, verticesOutline);
        }
