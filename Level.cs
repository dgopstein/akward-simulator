...
namespace awkwardsimulator
{
    public class Level
    {
        ...
        public static readonly GameState Level2 = new GameState(
            ...
            platforms: new List<Platform> {
                new Platform(new Vector2(80f, 10f), new Vector2(5f, 50f)),

                new Platform(new Vector2(40f, 10f), new Vector2(40f, 5f)),
                new Platform(new Vector2(80f, 10f), new Vector2(30f, 5f)),

                new Platform(new Vector2(60f, 25f), new Vector2(20f, 5f)),
                new Platform(new Vector2(95f, 25f), new Vector2(30f, 5f)),

                new Platform(new Vector2(40f, 40f), new Vector2(30f, 5f)),
                new Platform(new Vector2(80f, 40f), new Vector2(30f, 5f)),

                new Platform(new Vector2(60f, 55f), new Vector2(20f, 5f)),
                new Platform(new Vector2(95f, 55f), new Vector2(30f, 5f)),
            }
        );
    }
}
